...
- **When metrics look bad:** Class imbalance is fixable here; overfitting and hyperparameters are tackled in **Part 4 (Custom Data & Training)**.
:::
...
- Run training, read loss curves, and tune `lr0`, `weight_decay`, `patience`.
