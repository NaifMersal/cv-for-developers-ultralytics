...
::: {.r-stack}
![](https://ultralytics.com/assets/bus.jpg){.fragment width="400" height="300" style="margin-bottom: 20px;"}
...
::: {.column width="40%"}
![](https://cdn.jsdelivr.net/gh/ultralytics/assets@main/docs/sahi-sliced-inference-overview.avif)
:::
