...
```{=html}
<iframe class="interactive-demo r-stretch" src="demo_camera_sensor.html" width="100%" height="600px" style="border:none;"></iframe>
```
...
```{=html}
<iframe class="interactive-demo r-stretch" src="demo_rgb_pixel.html" width="100%" height="500px" style="border:none;"></iframe>
```
